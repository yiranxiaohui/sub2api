...
func TestEveryGatewayPOSTRouteIsClassifiedForPromptAuditCoverage(t *testing.T) {
	...
	excluded := map[string]string{
		"/api/event_logging/batch":    "Claude Code client telemetry forwarding has no inference prompt",
		"/api/event_logging/v2/batch": "Claude Code client telemetry forwarding has no inference prompt",
